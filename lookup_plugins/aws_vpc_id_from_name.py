...
###########################################################
# This required me to have a ~/.boto file to pass credentials
# boto 2.39 is supposed to support ~/.aws/ credentials but I
# was having errors and pulled the .boto info from a forum
# - Aaron 3/14/2016
###########################################################
